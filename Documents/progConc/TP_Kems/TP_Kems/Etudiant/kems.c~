...
main( int argc , char * argv[] ) 
{
 ...
 if( argc != 2 ) 
  ...
  if( ( paquet = paquet_creer() ) == PAQUET_NULL )
	...
	// TAPIS CENTRALE creation du tapis
  ...
  if( ( tapis_central = tapis_creer() ) == TAPIS_NULL )
	...
	// TAPIS CENTRALE distribution des cartes
  ...
  printf("\n");
	// TAPIS JOUEURS allocation memoire de tapis des joueurs
  ...
  if( ( tapis = malloc( sizeof(tapis_t *) * NbJoueurs ) ) == NULL )
	...
	// TAPIS CENTRALE creation du tapis des joueurs + distribution des cartes
